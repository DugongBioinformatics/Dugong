...
pkg-config libncurses5-dev libbz2-dev python-lzma liblzma-dev cython libcurl4-openssl-dev libxml2-dev libssl-dev libgtextutils-dev libcairo2-dev pandoc \
